...
public class LinePoint {
    private float x = 0;
    private float y = 0;
    public float predictY = 0;//动画曲线所需要
    ...
    private int strokeColor =android.R.color.black;
    private Style strokeStyle = Style.FILL; 
    /**
    ...
    private void init(Context context) {
        ...
        getStrokePaint().setStyle(strokeStyle);
	...
	public void setStrokeStyle(Style strokeStyle) {
		strokePaint.setStyle(strokeStyle);
	}
}
